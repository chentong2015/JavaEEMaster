package org.caching.problem;

import org.caching.problem.bloom_filter.DistributedBloomFilter;
import org.caching.problem.framework.Order;
import org.caching.problem.framework.OrderService;
import org.caching.problem.framework.SpringDataRedisConnection;
...
public class CachingProblemsDemo {

    StringRedisTemplate redisTemplate = SpringDataRedisConnection.getJedisStringTemplate();
